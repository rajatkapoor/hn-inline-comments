...
const markdown2 = `We can  **use** git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to mase git commit --amend to make
...
asd
  changes to our previous commit`;
    ...
    <Remark
      ...
      rehypeReactOptions={{
        ...
        components: {
          ...
          strong: ({ node, ...props }) => {
            console.log(
              "🚀 ~ file: EditorNew.jsx ~ line 28 ~ EditorNew ~ props",
              props
            );
            console.log(
              "🚀 ~ file: EditorNew.jsx ~ line 28 ~ EditorNew ~ node",
              node
            );
            return WithInlineComments(node, props);
          },
